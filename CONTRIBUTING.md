...
See [IDEAS.md](IDEAS.md) and `data/idea-template.json`. Keep observations, interpretations, proposed tests, and revision criteria separate. Preserve source dates and count denominators; identify company claims and preprints. New notes enter navigation and search automatically through `data/ideas.json`.
