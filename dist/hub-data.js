...
hubGlossary.push(['ADC', 'Analog-to-digital converter: samples a voltage signal and represents each sample with a finite number of bits. Input range, noise, bandwidth, and sampling rate affect useful resolution.', 'interfaces'], ['Aliasing', 'A sampling artifact in which unresolved high-frequency content appears at lower frequencies. Appropriate analog filtering and sampling are part of acquisition design.', 'signals'], ['Common reference', 'A shared reference used to express recorded voltages. The reference can introduce or remove shared signal components and must be documented.', 'interfaces'], ['Signal-to-noise ratio', 'A comparison of a defined signal contribution with a defined noise contribution. The value depends on the measurement, bandwidth, and chosen definition.', 'signals'], ['Data leakage', 'Information from evaluation data entering training, preprocessing, feature selection, or model decisions, producing an overly optimistic assessment.', 'signals'], ['Domain shift', 'A change in data conditions between training and use, such as a different subject, recording session, task, or acquisition system.', 'bci'], ['Latency', 'Delay between an event and the system response. Acquisition, buffering, processing, communication, and actuation can each contribute.', 'bci'], ['Jitter', 'Variation in timing or latency from event to event. A correct average delay does not guarantee consistent alignment.', 'behavior'], ['Reprojection error', 'The discrepancy between an observed image point and the image position predicted by a calibrated 3D reconstruction.', 'behavior'], ['ROI', 'Region of interest: a selected region, mask, or cell candidate used for analysis. Selection rules can affect results.', 'imaging'], ['Neuropil', 'The dense mesh of neuronal and glial processes surrounding cell bodies; its fluorescence can contribute to a calcium-imaging measurement near a selected cell.', 'imaging'], ['ΔF/F', 'A relative fluorescence-change measure, typically (F − F₀) / F₀. The baseline definition F₀ matters; the quantity is not itself a direct spike count.', 'imaging'], ['Deconvolution', 'Estimating a latent signal or event process from an observed signal using assumptions about how the measurement was generated.', 'signals'], ['Identifiability', 'Whether the available measurements can distinguish a model parameter or mechanism from competing possibilities.', 'computation'], ['Provenance', 'The record of where data came from and which processing steps, parameters, software versions, and decisions produced an output.', 'data'], ['FAIR', 'Findable, Accessible, Interoperable, and Reusable: principles for managing data and metadata. Accessible does not necessarily mean unrestricted.', 'data'], ['IDE', 'Investigational Device Exemption: a U.S. framework for certain investigational medical-device studies. An IDE is not marketing authorization or a demonstration of efficacy.', 'translation'], ['Endpoint', 'A defined measurement used to evaluate a study objective. Technical accuracy, functional performance, safety, and quality of life are distinct outcomes.', 'translation'], ['Biohybrid interface', 'An interface combining living biological components with engineered structures or devices. Integration and long-term function require their own evidence.', 'regeneration'], ['Organoid', 'A self-organizing three-dimensional cell culture that models some features of an organ. It does not reproduce every property of a mature human organ.', 'regeneration']);
const hubWorkedExamples = {
