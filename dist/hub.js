(function () {
    ...
    const labels = { overview: 'Overview', resources: 'Resource library', learn: 'Learning paths', glossary: 'Glossary', atlas: 'Technologies', organizations: 'Organizations', researchers: 'Researchers', frontier: 'Papers & updates', pathways: 'Study & careers', timeline: 'Milestones', about: 'Coverage & sources', search: 'Search', topic: 'Explore a topic' };
    const descriptions = {
