var I18N = (function () {
    ...
    lang = detectInitial();
    var S = {
        sourceRefreshNotice: { "en": "Some sources could not be refreshed. Previously retrieved items may be retained. ", "zh": "部分来源刷新失败，可能保留此前获取的条目。" },
        snapshotGenerated: { "en": "Snapshot generated ", "zh": "快照生成于 " },
        showingSpace: { "en": "Showing ", "zh": "显示 " },
        ofSpace: { "en": " of ", "zh": " / " },
        noDatedListings: { "en": "No listings match these filters.", "zh": "没有匹配这些筛选条件的职位条目。" },
        viewOriginalListing: { "en": "View original listing", "zh": "查看原始职位页面" },
        allRolesAtSpace: { "en": "All roles at ", "zh": "查看该雇主全部职位：" },
        employerRefreshNotice: { "en": "Some employers could not be refreshed. Check availability at the original source. ", "zh": "部分雇主的职位刷新失败，请在原始来源确认是否仍在招聘。" },
        listingsGenerated: { "en": "Listings snapshot generated ", "zh": "职位快照生成于 " },
        remoteSuffix: { "en": " · Remote", "zh": " · 远程" },
        curatedAvailability: { "en": " · availability not rechecked", "zh": " · 招聘状态尚未重新核实" },
        sourceDatePrefix: { "en": " · source date ", "zh": " · 来源日期 " },
        retainedStale: { "en": " · retained after a failed refresh", "zh": " · 刷新失败后保留的旧条目" },
        datedListings: { "en": "Dated listings", "zh": "注明日期的职位条目" },
        dateUnavailable: { "en": "Date unavailable", "zh": "日期未提供" },
        ...
        searchPlaceholderJobs: { en: 'Search dated listings, employer, location, or function...', zh: '搜索注明日期的职位条目、雇主、地点或职能……' },
        ...
        registeredTrials: { en: 'Lead-sponsored trials', zh: '作为主要申办方的注册试验' },
        registryCountScope: { en: 'Registry counts cover records naming this organization as lead sponsor. Zero does not mean no human studies: a university or hospital may sponsor the research. Read the clinical-status summary and source dates for context.', zh: '此处仅统计该机构作为主要申办方的注册记录。零不代表没有人体研究：试验可能由大学或医院申办。请结合临床状态说明及来源日期阅读。' },
    ...
    function tr(kind, id, field, fallback) {
        if (lang !== 'zh')
            return fallback;
