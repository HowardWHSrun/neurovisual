...
- **Researchers:** a portrait directory with 19 institutional image sources, graceful initials when a portrait is unavailable, linked technologies, and project timelines that distinguish source links from literature searches. Search, regional filters, and sorting remain available. See [portrait sources](data/researcher-media-sources.md).
- **Milestones:** an illustrated chronology with three era filters, source-credited research images, image enlargement, and direct technology details. Historical entries retain their dates; later contextual images identify their actual year and type.
