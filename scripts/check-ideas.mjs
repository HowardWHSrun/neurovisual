...
for (const path of ['dist/hub-utils.js','dist/ideas-data.js','dist/company-media.js','dist/labs-data.js','dist/visuals-data.js','dist/visuals.js','dist/connections-data.js','dist/connections.js','dist/ideas.js']) vm.runInContext(await read(path), context);
...
for(const path of ['dist/i18n.js','dist/hub-utils.js','dist/hub-data.js','dist/hub-guides.js','dist/labs-data.js','dist/visuals-data.js','dist/visuals.js','dist/connections-data.js','dist/connections.js','dist/field-visuals.js','dist/labs.js','dist/ideas-data.js','dist/company-media.js','dist/ideas.js']) vm.runInContext(await read(path),hubContext);
